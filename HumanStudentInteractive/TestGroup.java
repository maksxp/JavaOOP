...
static File fileToSave = new File ("C:/Users/mmurza.VTV/Desktop/Private/TestSource/ATO.txt");
static File fileToGroup = new File ("C:/Users/mmurza.VTV/Desktop/Private/TestSource/testToGroup.txt");
static AddableToGroup file = new FileToGroup (fileToGroup);
...
//	oneG.deleteStudent(threeS);
	...
	Group ATO = new Group(oneG.goToAto());
//	System.out.println(ATO);
	try {
		Group.groupToFile (ATO, fileToSave);
	} catch (IOException e) {
		System.out.println(e);
	}
		Group twoG =	Group.fileToGroup(file);
